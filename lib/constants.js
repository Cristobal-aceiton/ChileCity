...
export const RATE_CASINO_SEG   = Number(process.env.RATE_CASINO_SEG)   || 2;

// ── Límites de apuesta del Casino (Ruleta y futuros juegos) ──────────────────
export const CASINO_MIN_APUESTA = Number(process.env.CASINO_MIN_APUESTA) || 1000;
export const CASINO_MAX_APUESTA = Number(process.env.CASINO_MAX_APUESTA) || 50000000;
