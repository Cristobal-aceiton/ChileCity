    ...
    // Workaround para un bug conocido de iOS Safari: la combinación de
    // -webkit-overflow-scrolling:touch + overscroll-behavior:contain (ambas
    // están en .pp-screen, vía CSS) hace que, si el contenido cambia de alto
    // de golpe (como al abrir una card o mostrar un panel con muchos logros),
    // el scroll quede "trabado" y deje de responder hacia arriba.
    // El fix anterior solo apagaba/prendía -webkit-overflow-scrolling, pero
    // dejaba overscroll-behavior:contain activo todo el tiempo, que es la
    // otra mitad de la combinación que gatilla el freeze. Ahora se sueltan
    // ambas propiedades, se fuerza un reflow real (toggle de overflow, no
    // solo lectura de offsetHeight) y se restauran en el frame siguiente.
